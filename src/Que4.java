...
public class Que4 extends JFrame {
	 ...
	 * @throws SQLException 
	 */
	public Que4() throws SQLException {
		setTitle("Show all donors for each blood type");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Que4.class.getResource("/images/logo1.jpg")));
		...
		scrollPane.setBounds(41, 25, 401, 227);
