...
public class Que6 extends JFrame {
	 ...
	 */
	public Que6() {
		setTitle("Show highest bloodstock in a certain period of time");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Que6.class.getResource("/images/logo1.jpg")));
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 495, 414);
		...
		dateChooser1.setBounds(190, 31, 230, 40);
		...
		label_1.setBounds(54, 82, 126, 40);
		contentPane.add(label_1);
		
		 dateChooser2 = new JDateChooser();
		dateChooser2.setBounds(190, 82, 230, 40);
		...
		button.setBounds(54, 159, 366, 45);
		contentPane.add(button);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(54, 215, 366, 140);
