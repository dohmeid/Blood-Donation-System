...
public class DonationDeleteUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DonationDeleteUI frame = new DonationDeleteUI();
	 ...
	 * Create the frame.
	 */
	public DonationDeleteUI() {
		setTitle("Deleting A Blood Donation Operation");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DonationDeleteUI.class.getResource("/images/logo1.jpg")));
		...
		JLabel lblEnterTheId = new JLabel("Enter the id for the donation operation to delete");
		...
		JLabel lblDeletingABlood = new JLabel("Deleting A Blood Donation Operation");
	...
	private void jButtonActionPerformed(java.awt.event.ActionEvent e) throws SQLException  {
		...
		else if(dr.search(Integer.valueOf(tf.getText()), 3) == 0){
